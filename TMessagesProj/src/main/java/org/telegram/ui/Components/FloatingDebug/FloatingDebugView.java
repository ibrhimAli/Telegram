...
import org.telegram.ui.profile.utils.Logging;
...
public class FloatingDebugView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    private List<FloatingDebugController.DebugItem> getBuiltInDebugItems() {
        ...
        items.add(new FloatingDebugController.DebugItem(LocaleController.getString(R.string.DebugSendLogs), () -> Logging.sendLogs((Activity) getContext(), false)));
        return items;
    }
